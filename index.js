...
const unfundedGames = listofUnfundedGames.reduce( (acc,game) => acc + 1, 0);


// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `<p>A total of $${amountRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length.toLocaleString('en-US')} games. Currently, ${unfundedGames.toLocaleString('en-US')} ${unfundedGames > 1 ? "games remain" : "game remains"} unfunded. We need your help to fund these amazing games</p>`
